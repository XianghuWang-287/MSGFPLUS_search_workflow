...
if __name__ == "__main__":
    ...
    falcon_x = [8, 24, 25, 26, 26,27,28,29]
    falcon_y = [0.9896683397928712,0.9748935149079129,0.973328106397189,0.972145244693312,0.9704464146834656,0.9644083403302547,0.9517989980264157,0.9440309209358226]

    # maracluster_x = [17,17,16,14,11]
    maracluster_x = [31,29,27,25,23, 21, 18, 16, 14]
    maracluster_y = [0.9213125354578562,0.9393937545370805,0.9549921611448998,0.972550831792976,0.9771322946923686,0.9806311064166887,0.9839054660681278,0.9875231053604436,0.9911407446527595]

    mscluster_x_DB = [13,17, 21, 25, 29, 30, 37, 40]
    mscluster_y_DB = [0.9967752743110814,0.9949272165857962, 0.992179469370746, 0.986520160114519, 0.9781656533960907,
                        0.9713526400125063, 0.9468156742897101, 0.9329887582374984]

    falcon_x_DB = [8, 24, 25, 26, 26,27,28,29]
    falcon_y_DB = [0.9986930332992385, 0.9934939725609333, 0.9922738938231461, 0.9908004652638257, 0.9891556020668455,0.9848380962237545, 0.9785751028806584,0.9672613714900044]

    maracluster_x_DB = [14, 16, 18, 21, 23, 25,27,28,31]
    maracluster_y_DB = [0.9974578538934975, 0.9967888680759968, 0.9959374315809959, 0.9948548908944949,
                        0.9934804291239935, 0.988992142457489,0.9549921611448998,0.9393937545370805,0.9213125354578562]

    mscluster_x_MSRT=[13,17,21,25,29,30,37,40]
    mscluster_y_MSRT=[0.9764721772015127,0.9736076522679645,0.9692229618794591,0.9601011399674295,0.9533140396696548,0.9497304221743599,0.9363323156214112,0.9283237802320704]
